...
const Detail = () => {
  ...
  useEffect(() => {
    api.get(`points/${routeParms.point_id}`).then(response => setPoint(response.data));
  },[]);
    ...
    <SafeAreaView style={{ flex: 1 }}>
      <View style={styles.container}>
        ...
        <Text style={styles.pointItems}>
          { point.items.reduce((prevItem, currItem, idx) => idx === 0 ? currItem.title : prevItem + ', ' + currItem.title, '')}
        </Text>
